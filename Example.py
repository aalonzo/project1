...
def main():
	...
	update_scene(bg_image, bottom_button_frame, dialog_box, status_bar, "corgi_backyard_right.png", "Hi, I'm playing on the right side of the backyard!", "Max is on the right.")
	...
	prev = Button(text="Right", command=lambda: update_scene(bg_image, bottom_button_frame, dialog_box, status_bar, "corgi_backyard_right.png", "Hi, I'm playing on the right side of the backyard!", "Max is on the right."))
	next = Button(text="Left", command=lambda: update_scene(bg_image, bottom_button_frame, dialog_box, status_bar, "corgi_backyard_left.png", "Now I'm on the left!", "Max is on the left."))
